...
const Dbms = () => {
  ...
  const [questions,setQuestions]=useState(questions_array.sort(() => Math.random() - 0.5))
  ...
  return (
    ...
    <p className='flex justify-end text-2xl p-2'><Link to="/dp">Back</Link></p>
    <div className='flex m-8 p-4 bg-gray-700 flex-col justify-center items-center'>
      <h1 className='text-blue-200 text-4xl underline pb-4'>DBMS</h1>
